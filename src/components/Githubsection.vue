            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                ...
                <div class="space-y-1.5">
                    <label class="flex items-center gap-1.5 text-[11px] text-gray-400 font-medium">
                        ...
                        <button
                            title="A PAT is required to authenticate with GitHub API"
                    ...
                    <div class="relative">
                        <input
                            :value="patValue"
                            @input="$emit('update:patValue', $event.target.value)"
                        ...
                        >
                            <img v-if="!showPat" :src="passShowIcon" width="14" height="14" alt="" class="opacity-60 invert-md brightness-0" />
                            <img v-else          :src="passHideIcon"  width="14" height="14" alt="" class="opacity-60  invert-md brightness-0" />
                        </button>
                    </div>
                </div>
